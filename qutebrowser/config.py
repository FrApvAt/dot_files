...
c.content.headers.user_agent = 'Mozilla/5.0 (Windows NT 10.0; WOW64; x64) AppleWebKit/{webkit_version} (KHTML, like Gecko) {upstream_browser_key}/{upstream_browser_version} Safari/{webkit_version}'
...
config.bind('M', 'hint links spawn /app/bin/mpv {hint-url}', mode='normal')
